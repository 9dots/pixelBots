...
const pickUp = createAction('pickUp', (...args) => args)
...
function * pickUpAndMove (lineNum, fn, num = 1) {
  console.log('pick up and move', lineNum, fn, num)
  for (let i = 0; i < num; i++) {
    yield fn()
  }
}
...
const capabilities = {
  ...
  pickUpMoveRight: {
    type: 'memory',
    description: 'Pick up on current square and then move right.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  pickUpMoveDown: {
    type: 'memory',
    description: 'Pick up on current square and then move down.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  pickUpMoveLeft: {
    type: 'memory',
    description: 'Pick up on current square and then move left.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  pickUpMoveUp: {
    type: 'memory',
    description: 'Pick up on current square and then move up.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  placeMoveRight: {
    type: 'memory',
    description: 'Place on current square and then move right.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  placeMoveDown: {
    type: 'memory',
    description: 'Place on current square and then move down.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  placeMoveLeft: {
    type: 'memory',
    description: 'Place on current square and then move left.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  placeMoveUp: {
    type: 'memory',
    description: 'Place on current square and then move up.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  paintMoveLeft: {
    type: 'memory',
    description: 'paint on current square and then move left.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  paintMoveRight: {
    type: 'memory',
    description: 'Paint on current square and then move right.',
    args: [
      {
        name: 'num',
        type: 'number',
  ...
  wrapMoveRight: {
    type: 'move',
    description:
      'Move the pixelbot to the right. If the bot is at the edge of the grid move to the left side of the next line.'
  },
  wrapMoveLeft: {
    type: 'move',
    description:
      'Move the pixelbot to the left. If the bot is at the edge of the grid move to the right side of the next line.'
  },
  pickUpAndMove: {
    hidden: true
  },
