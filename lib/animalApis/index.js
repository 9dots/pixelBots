...
const capabilities = {
  ...
  rand: {
    ...
    args: [{
      ...
      default: 0,
      balues: range(1, 10),
      description: 'The bottom end of the possible randoms',
    },
    {
      name: 'max',
      type: 'number',
      default: 10,
      balues: range(1, 10),
      description: 'The top end of the possible randoms',
    }]
  },
  repeat: {
...
export default function (spec, id) {
  return map(
    (params, key) => capabilities[key].action
...
export function enableAllCapabilities () {
