...
const capabilities = {
  ...
  wrapMoveRight: {
    type: 'move',
    description: 'Move the pixelbot to the right. If the bot is at the edge of the grid move to the left side of the next line.'
  },
  wrapMoveLeft: {
    type: 'move',
    description: 'Move the pixelbot to the left. If the bot is at the edge of the grid move to the right side of the next line.'
  },
  pickUpAndMove: {
    type: 'move',
    hidden: true
