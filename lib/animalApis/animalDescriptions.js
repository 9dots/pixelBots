export default {
  ...
  chameleon: {
    description: 'The chameleon can use arguments to paint in all of the colors. It can only move one space at a time.',
    image: '/animalImages/chameleon.jpg'
  },
  toucan: {
  ...
  crocodile: {
    description: 'The crocodile moves on space at a time and can change the direction it is facing.',
    image: '/animalImages/crocodile.jpg'
  },
  penguin: {
    description: 'The penguin is the first animal that can use LOOPS.',
    image: '/animalImages/penguin.jpg'
  }
}
