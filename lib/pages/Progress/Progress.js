...
export default fire((props) => ({
  ...
  render ({props, context}) {
  	...
  	const slicedLists = orderedLists.slice(1)
						...
						<Block flex>
							{
								length
									? <Block>
											{
												onlyCompleted 
													?	<EmptyState mt={-80} icon='access_time' title='In Progress Playlists' description={'Playlists you have started will will appear here. Playlists you\'ve completed are below.'} />
													: <Lists lists={slicedLists} />
											}
