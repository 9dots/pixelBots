...
export default fire((props) => ({
  ...
  render ({props, context}) {
    ...
    return (
    	<Block tall wide bg='#f0f0f0' align='start'>
    		<Sidebar items={value} />
				<Block p='l' pt flex>
...
const Sidebar = component({
	render({props}) {
		...
		return (
			<Block tall w={180} borderRight='1px solid grey' bg='#FAFAFA'>
...
const Item = component({
	render({props, context}) {
		...
		return (
			<Link bgColor='#FAFAFA' color='primary' fs='xs' align='start center' ui={MenuItem} currentProps={{bgColor: '#EEE'}} ellipsis {...rest}>
