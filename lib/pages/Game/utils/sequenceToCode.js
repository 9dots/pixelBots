  ...
  return blocks
    .map(({ type, payload }) => {
      ...
      switch (type) {
        ...
        case 'pickUpMoveUp':
          return `${indent}pickUpAndMove(function () {pickUp(); up()}, ${args})`
        case 'pickUpMoveRight':
          return `${indent}pickUpAndMove(function () {pickUp(); right()}, ${args})`
        case 'pickUpMoveDown':
          return `${indent}pickUpAndMove(function () {pickUp(); down()}, ${args})`
        case 'pickUpMoveLeft':
          return `${indent}pickUpAndMove(function () {pickUp(); left()}, ${args})`
        case 'placeMoveUp':
          return `${indent}pickUpAndMove(function () {place(); up()}, ${args})`
        case 'placeMoveRight':
          return `${indent}pickUpAndMove(function () {place(); right()}, ${args})`
        case 'placeMoveDown':
          return `${indent}pickUpAndMove(function () {place(); down()}, ${args})`
        case 'placeMoveLeft':
          return `${indent}pickUpAndMove(function () {place(); left()}, ${args})`
        case 'paintMoveLeft':
          return `${indent}pickUpAndMove(function () {paint(); left()}, ${args})`
        case 'paintMoveRight':
          return `${indent}pickUpAndMove(function () {paint(); right()}, ${args})`
        case 'pickUp':
