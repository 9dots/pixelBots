...
import {Box, Block, Flex, Menu, Text, Image} from 'vdux-ui'
      ...
      <Layout
        ...
        <Block mx='20px'>
          <Block align='start' mb='l'>
            <Image src={imageUrl} border='1px solid divider' sq={150} mr='l' />
            <Block column align='space-around' h={150} flex mr='l'>
