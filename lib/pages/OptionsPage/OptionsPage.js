...
export default component({
  render ({props, actions, children}) {
	  ...
	  const animalType = animals[0].type
		const checkProps = {checkProps: {borderRadius: 5, sq: 24, fs: 's', bold: true}}
	      ...
	      <Block bgColor='white'>
	        ...
	        <DropdownField label='Movement' {...rowProps}>
	        	<Table w='60%' ml={-12} borderCollapse='collapse' border='1px solid divider'>
	        		<TableRow>
	        			<TableHeader py='s' px textAlign='left'>
	        				Direction
	        			</TableHeader>
		        	...
		        	{
		        		['up', 'down', 'left', 'right', 'forward', 'turnLeft', 'turnRight'].map((dir, i) => (
