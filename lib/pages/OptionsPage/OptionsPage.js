        ...
        <Block>
          ...
          <DropdownField label='Paints' {...rowProps}>
            <Table w='60%' ml={-12} borderCollapse='collapse' border='1px solid divider'>
            {
                ...
                return (
                  <TableRow bgColor={i % 2 ? 'white' : '#FAFAFA'}>
                    <TableCell py='s' px fontFamily='monospace'>
                      <Checkbox {...checkProps}
                        label={<Block my={-4} align='start center'>Paint <BlockIcon ml='s' name={name} color='#555' /></Block>}
              ...
              <TableRow bgColor='#FAFAFA'>
                <TableCell py='s' px fontFamily='monospace'>
                  <Checkbox {...checkProps}
                    label={<Block my={-4} align='start center'>Toggle <BlockIcon ml='s' name='toggle' color='#555' /> </Block>}
          ...
          <DropdownField label='Structural' {...rowProps} borderBottomWidth='1'>
            <Table>
              ...
              <TableRow>
                <TableCell>
                  <Checkbox {...checkProps} pb checked={!!capabilities.createFunction} onChange={updateGame({
                    capabilities: {
                      ...capabilities,
                      createFunction: capabilities.createFunction ? null : true
                    }
                  })} label={<Text>Create Functions (icons only)</Text>} />
                </TableCell>
              </TableRow>
            </Table>
          </DropdownField>
