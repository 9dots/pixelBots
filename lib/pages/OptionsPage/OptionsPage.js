...
import {Table, TableRow, TableCell, Block, Icon, Text} from 'vdux-ui'
	  ...
	  return (
	    <Block wide mx='auto' maxWidth={750}>
	      <Block bgColor='white'>
	        ...
	        <DropdownField label='Painting' {...rowProps}>
	        	<Toggle
	        		checked={capabilities.paint !== true}
	        		onChange={updateGame({
	        			capabilities: {
	        				...capabilities,
	        				paint: capabilities.paint === true
	        					? [{}]
	        					: true
	        			}
	        		})} />
