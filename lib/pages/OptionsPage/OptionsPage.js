              ...
              <TableRow>
                <TableCell>
                  <Checkbox
                    {...checkProps}
                    pb
                    checked={!!capabilities.ifStatement}
                    onChange={updateGame({
                      capabilities: {
                        ...capabilities,
                        ifStatement: capabilities.ifStatement ? null : [true]
                      }
                    })}
                    label={
                      <Text>
              ...
              <TableRow>
                <TableCell>
                  <Checkbox
                    {...checkProps}
                    pb
                    checked={!!capabilities.setFrameRate}
                    onChange={updateGame({
                      capabilities: {
                        ...capabilities,
                        setFrameRate: capabilities.setFrameRate ? null : [true]
                      }
                    })}
                    label={
                      <Text>
              ...
              <TableRow>
                <TableCell>
                  <Checkbox
                    {...checkProps}
                    pb
                    checked={!!capabilities.rand}
                    onChange={updateGame({
                      capabilities: {
                        ...capabilities,
                        rand: capabilities.rand ? null : [true]
                      }
                    })}
                    label={
                      <Text>
