...
const paintMove = ['paintMoveRight', 'paintMoveLeft']
                      ...
                      <Checkbox
                        ...
                        label={
                          <Block my={-4} align='start center'>
                            Paint <BlockIcon ml='s' type={name} color='#555' />
                          </Block>
                        }
            ...
            <Table w='60%' ml={-12} border='1px solid divider'>
              <TableRow>
                ...
                <TableCell>
                  <Dropdown
                    zIndex={999}
                    btn={<DropdownButton text={inventorySize} />}>
                  ...
                  <TableCell py='s' pl>
                    <Toggle
                      ...
                      onChange={updateGame({
                        capabilities: {
                          ...capabilities,
                          [cap]: Array.isArray(capabilities[cap])
                            ? true
                            : [true]
                        }
                      })} />
