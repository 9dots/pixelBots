...
const router = enroute({
  options: (params, props) => <OptionsPage
    {...props.newGame.value}
    {...omit('title', props)}>
    {props.btn}
  </OptionsPage>,
  create: (params, props) => <GameTypeOptions
    ...
    {...props} />,
  preview: (params, props) => <GameLoader
    initialData={props.newGame.value}
    {...props} />,
  solution: (params, props) => <GameLoader
    initialData={props.newGame.value}
    {...props} />,
      ...
      <Block align='start center'>
        <Button
  	    ...
  	    <FlowTracker
  	      ...
  	      active={step}
  	      mr
  	      steps={['options', 'create', newGame.value && newGame.value.advanced ? 'solution' : 'preview', props.new && 'publish']} />
  	  </Block>
    )
