...
import {component, element, stopPropogation} from 'vdux'
...
export default fire((props) => ({
  ...
  render ({props, context}) {
    ...
    return (
      <ListItem {...style} mb p='1em' wide align='start stretch' onClick={clickHandler}>
          ...
          <Block hide={hideProgress}>
            {
              isComplete
                ...
                : <Block align='start center' >
                    ...
                    <Block ml wide bg='divider' h={10} borderRadius={99} ellipsis relative w='70%'>
