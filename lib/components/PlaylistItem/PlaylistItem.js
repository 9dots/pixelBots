...
export default fire((props) => ({
  ...
  render ({props, context}) {
    ...
    return (
      <ListItem p='1em' wide align='start stretch' onClick={clickHandler}>
        <Block mr='20px'>
          {
            value.imageUrl 
              ? <Image sq={imageSize} src={value.imageUrl} border='1px solid grey' />
              : <Block sq={imageSize} bgColor='#EEE' align='center center' border='1px solid grey'>
                  <Icon name='view_list' fs={imageSize * .6} color='primary' />
                </Block> 
          }
        </Block>
