      ...
      <Block {...rest}>
        <Block align='center center'>
          <Button
            ...
            w={w / 3}
            h={h / 2}>
            <Icon fontWeight='bold' color={arrowColors.up} name={iconUp} />
          </Button>
        </Block>
        <Block align='stretch center'>
          <Button
            ...
            <Icon fontWeight='bold' color={arrowColors.left} name={iconLeft} />
          </Button>
        ...
        <Block align='center center' mt={-4}>
          <Button
            ...
            <Icon fontWeight='bold' color={arrowColors.down} name={iconDown} />
          </Button>
        </Block>
      </Block>
    )
