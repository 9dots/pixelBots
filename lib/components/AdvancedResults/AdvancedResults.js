  ...
  render ({props, state, context}) {
    ...
    return (
      <Modal w='650px' onDismiss={context.closeModal} borderRadius={10} relative p='16px 16px 8px 125px' boxShadow='rgba(0,0,0, 1) 0px 0px 140px' mt={80}>
        ...
        <Block align='center center' h={375}>
          {
            results
        ...
        {
          (results && (!failedSeeds || failedSeeds.length === 0)) && (
            <Block>
              <Button onClick={context.closeModal} {...btnProps}>Refactor</Button>
              <Button onClick={props.onComplete} {...btnProps}>Submit</Button>
            </Block>
          )
        }
      </Modal>
    ...
    return (
      <Block wide>
        ...
        <Block mt={28} mb={10} mx='auto' align='center center'>
          <Block w={380}>
            <Block align='space-between center' relative wide>
              <Grid
                levelSize={gridWidth}
                animals={[]}
