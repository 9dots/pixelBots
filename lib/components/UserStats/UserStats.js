    	...
    	<Block w='720px' mx='auto'>
    		<Block mb='l' bgColor='white' border='1px solid divider'>
    			...
    			<Block align='space-around center' p='l'>
	    			<Badge color='yellow' name='Completed' count={badges.completed || 0} icon='star' />
	    			<Badge color='blue' name='Line Limit' count={2} icon='view_list' />
	    			<Badge color='green' name='Step Limit' count={0} icon='show_chart' />
    			</Block>
    		</Block>
