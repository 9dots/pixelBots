...
export default component({
  render ({props}) {
    const {badges = {}, stats = {}} = props.thisProfile.value
    const {completed = 0, lineLimit = 0, stepLimit = 0, errorLimit = 0} = badges
