          ...
          <Block tall>
            ...
            }
            {
              !connected && <Transition>
                <Toast key='a' bg='red' color='white' align='center center' w={600}>
                  <Block align='center center'>
                    <Icon name='error' fs='m' mr='s' />
                    <Text fw='bolder' mr='s'>Oops!</Text>
                    <Text fw='lighter'>You've lost connection. Please don't refresh while we try to reconnect.</Text>
                  </Block>
                </Toast>
              </Transition>
            }
