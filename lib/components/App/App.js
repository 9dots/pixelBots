      ...
      return (
        <Block tall relative>
          ...
          <Block tall>
            ...
            {
              !connected && process.env.NODE_ENV !== 'dev' && 
                <Transition>
                  <Toast key='a' bg='red' color='white' align='center center' w={520}>
                    <Block align='center center'>
                      <Icon name='error' fs='m' mr />
                      <Text fw='bolder' mr>CONNECTION LOST:</Text>
                      <Text fw='lighter'>Please check your internet connection. Refreshing right now will lose progress.</Text>
                    </Block>
                  </Toast>
                </Transition>
            }
