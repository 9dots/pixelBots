...
export default component({
  render ({props}) {
	  const {clickHandler, swatchSize = '24px', animalType, permissions, setFillColor, setPaintMode, paintColor, ...restProps} = props
	  let close
	  ...
	  return (
	  	<Block align='start center' {...restProps}>
	  		<Button {...btnProps} px='20' borderRadius='3px 0 0 3px' borderRightWidth={0}>
