...
export default component({
  render ({props}) {
	  const {clickHandler, animalPaint, swatchSize = '24px', animalType, permissions, dropdownHandler, paintColor, ...restProps} = props
	  let close
	  ...
	  const btn = (
	    <Button {...btnProps} borderRadius='0 3px 3px 0' w={btnProps.h}>
	      <Block
	  ...
	  return (
	  	<Block align='start center' {...restProps}>
	  		<Button {...btnProps} px='20' borderRadius='3px 0 0 3px' borderRightWidth={0} onClick={clickHandler}>
