...
const ShowcaseButton = component({
  render ({props, actions}) {
    ...
    return (
      shared
        ? <Button fs='xs' bgColor='white' border='1px solid #e0e0e0' color='#666' onClick={actions.removeFromShowcase}>Remove from showcase</Button>
        : <Button fs='xs' bgColor='white' border='1px solid #e0e0e0' color='#666' onClick={actions.addToShowcase}>Add to showcase</Button>
    )
  },
  controller: {
