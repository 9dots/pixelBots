...
export default fire((props) => ({
  ...
  render ({props, children, context, actions, state}) {
    ...
    const animalImg = `/animalImages/${value.animals[0]}.jpg`
    ...
    return (
      <ListItem
        ...
        <Block hide={!value.shared} absolute top right borderTop='30px solid #f76a59' borderLeft='30px solid transparent' />
      </ListItem>
    )
  },
  reducer: {
