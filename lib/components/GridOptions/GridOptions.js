...
export default component({
	initialState ({props}) {
		return {
			...
			targetGrid: !props.isProject,
      startGrid: !!props.isProject
		}
	},
      	...
      	<Block minWidth='1132' align='start center' column>
              ...
              !props.isProject && <Toggle
                ...
                onChange={toggleTarget} />
      			...
      			<Toggle mx={props.isProject} px={props.isProject} checked={startCode} label='Start Code' borderRadius='0 3px 3px 0' onChange={toggleCode} borderLeftWidth={0} />
      		</Block>
