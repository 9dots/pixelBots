...
export default component({
  initialState ({ props }) {
    return {
      targetGrid: props.type !== 'project' && props.type !== 'sandbox',
      startGrid: props.type === 'project' || props.type === 'sandbox',
          ...
          {advanced ? (
            ...
            <Block
              ...
              <GridBlock
                ...
                title='Start Grid'
                palette={props.palette.concat({
                  name: 'toggle',
                  value: 'url("/images/togglePixel.png")'
                })}
