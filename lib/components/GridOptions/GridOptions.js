...
export default component({
  ...
  render ({props, state, actions, children}) {
  	...
  	const {targetPainted, initialPainted, targetGrid, startGrid, startCode, advanced} = state
    ...
    return (
      <Block tall wide>
      	<Block minWidth='1045' align='start center' column>
  ...
  * onRemove ({actions, props, context, state}) {
  ...
  reducer: {
    ...
    toggleAdvanced: (state) => ({advanced: !state.advanced})
  }
})