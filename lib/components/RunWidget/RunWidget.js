	  ...
	  return (
	  	<Block bgColor='white' border='1px solid divider' mt='0.5em' wide p='10px'>
	  		<Block align='center center'>
		  		<GameButton flex={!hasSubmit} maxWidth={90} disabled={advanced ?running || teacherBotRunning : running || !hasRun } bg='red' mr='s' onClick={gameActions.reset()} py='3px' {...btnProps}>
		  		...
		  		<GameButton flex={!hasSubmit} maxWidth={90} disabled={completed || running || !hasCode || teacherBotRunning} bg='yellow' onClick={gameActions.stepForward()} py='3px' {...btnProps}>
