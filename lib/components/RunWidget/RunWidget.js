    ...
    return (
      <Block bgColor='white' border='1px solid divider' mt='0.5em' wide p='10px'>
        <Block align='center center'>
          <GameButton
            disabled={teacherBotRunning || running || !hasRun}
          ...
          <GameButton
            disabled={!hasCode || teacherBotRunning}
          ...
          <GameButton
            disabled={completed || running || !hasCode || teacherBotRunning}
          ...
          {(
            hasSubmit &&
              <GameButton
                disabled={running || !hasCode || teacherBotRunning}
                onClick={onComplete}
                p='3px 14px'
                bg='blue'
                fs={17}
