...
export default component({
  render ({props, actions}) {
		const {hasRun, speed, running, canRun, steps = 0, completed, gameActions} = props
	  ...
	  return (
	  	<Block bgColor='white' border='1px solid divider' mt='0.5em' wide p='10px'>
	  		<Block align='center center'>
		  		...
		  		<GameButton disabled={running || completed} bg='yellow' onClick={gameActions.stepForward()} p='5px 24px'>
