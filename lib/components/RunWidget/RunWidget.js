...
export default component({
  render ({props, actions}) {
		const {hasRun, speed, running, canRun, steps = 0, completed, setSpeed, reset, stepForward, hasCode, runCode} = props
	  ...
	  return (
	  	<Block bgColor='white' border='1px solid divider' mt='0.5em' wide p='10px'>
	  		<Block align='center center'>
		  		...
		  		<GameButton disabled={!hasCode} bg='green' mr='s' flex onClick={[reset, runCode]}>
