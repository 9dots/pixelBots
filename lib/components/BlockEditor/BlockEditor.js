    ...
    return (
      <Block id={`code-block-${line}`} class={['code-block', {'active': active, 'new': isAtCursor}]} {...rest}>
        ...
        <Block wide align='start' relative {...rest}>
          <LineNumber line={line} selected={selected} select={select} hovering={hovering} unselectable={!readOnly && docs.unselectable} numLineDigits={numLineDigits} block={block} />
          {
