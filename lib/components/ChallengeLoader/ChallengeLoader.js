	    ...
	    <Block>
	      ...
	      <ListItem
	        ...
	        <Block align='start center'>
	          ...
	          <Box w={colWidth} minWidth={colWidth} fs='s' color='primary' align='start center'>
	            {
	            	item.inputType === 'code' 
	          ...
	          <Box hide={isComplete !== undefined} w={colWidth} minWidth={colWidth}>
	            {lastEdited && moment(lastEdited).fromNow()}
	          </Box>
	          <Block hide={isComplete === undefined} w={colWidth} minWidth={colWidth} align='end center'>
	          	{
