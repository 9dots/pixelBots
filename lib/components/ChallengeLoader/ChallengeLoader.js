	      ...
	      <ListItem
	        ...
	        <Block align='start center'>
	          <Box align='start center' w='50%' minWidth={300} pr>
	          	<Block align='start center'>
	          		<DragHandle
	            		...
	            		ref={ref}/>
		            <Block mr={20} sq={70} border='1px solid grey' bgImg={game.value.imageUrl || '/animalImages/teacherBot.png'} backgroundSize='cover' />
	            </Block>
	          ...
	          <Block hide={isComplete === undefined} flex align='end center'>
          		...
          		<Status 
          			bgColor={isComplete ? 'green' : '#bbbbbb'} 
...
const Status = component({
	render: function({props}) {
		...
		return (
			<Icon name={icon} bold circle={31} fs={19} {...rest} align='center center' />
		)
	}
