...
export default component({
  render ({ props, context }) {
    ...
    const type = props.type || game.value.type || 'write'
        ...
        <MainLayout
          ...
          <Block align='space-between center' mt={-20} mb>
            <GameButton
              ...
              bgColor='green'
              mr
              onClick={context.setUrl(`${baseUrl}/${current}`)}>
            ...
            {isLast ? (
              ...
              <GameButton
                ...
                onClick={context.setUrl(
                  type === 'game' ? `/map/view` : `${baseUrl}/${current + 1}`
                )}>
                Next
          ...
          <Block align='start stretch'>
            <Tile header='Challenge Badges' flex relative>
              <ResultBadges
                py='l'
                w='85%'
                mx='auto'
