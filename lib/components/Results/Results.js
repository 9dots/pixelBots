...
export default component({
  render ({ props, context }) {
    ...
    const { loc, modifications } = (value && value.meta) || {}
            ...
            <Block align='start stretch'>
              <Tile header='Badges' flex relative>
                <Image
                  ...
                  m='auto'
                  z={2} />
                <Block pt='l' pb pl={100} w='80%' mx='auto'>
                  <BadgeLine
                    hasBadge={true}
                    title='Completed'
                    type='completed'
                  ...
                  <BadgeLine
                    ...
                    hide={type !== 'read'} />
                  <BadgeLine
                    hasBadge={stretch.type === 'modLimit'}
                    limit={stretch.value}
                    title='Change Limit'
                    type='modLimit'
                    noun='change'
                    count={modifications}
                    hide={stretch.type !== 'modLimit'} />
