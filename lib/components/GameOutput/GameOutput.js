		...
		return (
			<Block mr='10px'>
				<Block relative pt='0' align='top' height='100%' mb>
					<Block mr={12}  relative w={200}>
						<Block border='1px solid divider' bg='white' column align='stretch center' h={350}>
						...
						<Block bgColor='white' p='s' border='1px solid divider' mt={8} h={147} hide={!inventorySize} column align='space-between start'>
