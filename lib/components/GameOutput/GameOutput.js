...
import InstructionsButton from '../InstrctionsButton/InstructionsButton';
        ...
        <Block relative pt='0' align='top' height='100%' mb>
          <Block
            ...
            <Block overflowY='auto' p sq='100%'>
              ...
              <Block column flex tall hide={view !== 'grid'}>
                <Block mt='-6' pb='s' align='space-between center'>
                  <Block fs='xs' wide lh='25px' py={isSandbox || isProject ? 'l' : 'm'}>
                    <b>{isSandbox || isProject ? '' : 'GOAL:'}</b>
                    {!isSandbox && <InstructionsButton html={html} />}
                ...
                <Block borderTop='1px solid divider' pt='s'>
                  <DebugStats type={type} meta={meta} errors={invalidCount} />
                </Block>
              </Block>
              <Block hide={view !== 'info'} innerHTML={html} lh='1.4em' />
              <Block flex column tall hide={view !== 'debugStats'}>
                <Block tall borderBottom='1px solid divider' mb>
                  <Block pb borderBottom='1px solid divider'>
                    <b>Debug Stats</b>
                    {!isSandbox && <InstructionsButton html={html} m='-2px -2px 0 0' />}
                  </Block>
                  <DebugStats type={type} meta={meta} errors={invalidCount} />
                </Block>
                {Object.keys(initialPainted).length ? (
