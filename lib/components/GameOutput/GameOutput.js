				...
				<Block relative pt='0' align='top' height='100%' mb>
					...
					<Block >
						<Block relative zIndex='10'>
							...
							{
								canPaint &&
									<Block bgColor='white' border='1px solid divider' mt='0.5em' wide p={12} align='cetner center'>
										<Block align='space-between center' flex>
											{
										...
										<Block ml='s' borderLeft='1px solid divider' >
											<Block>
												<Button ml='8' {...btnProps('blue')} h={35} fs='15' w={80} onClick={props.onComplete()}>
													CHECK
												</Button>
											</Block>
											<ResetBoardButton
