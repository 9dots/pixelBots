...
import { Block as UiBlock } from 'vdux-ui'
            ...
            <Block overflowY='auto' p sq='100%'>
              ...
              <Block column flex tall hide={view !== 'grid'}>
                <Block mt='-6' pb='s' align='space-between center'>
                  <Block fs='xs' py wide lh='25px'>
                    {isSandbox ? '' : 'GOAL:'}
                    {html && <Icon color='blue' name='help_outline' float='right' pointer onClick={context.openModal(() => <BotModal
