...
import {up, down, left, right} from 'utils/frameReducer'
...
export default component({
	...
	render ({props, state, actions, context}) {
		...
		const numBlocks = 4
		const numBtns = 7
		const btnWidth = (326 - (btnMargin * (numBlocks - 1))) / numBtns
			...
			<Block mr='10px'>
				<Block relative pt='0' align='top' height='100%' mb>
					<Block mr={12}  relative w={200}>
						...
						<Block bgColor='white' p border='1px solid divider' mt={8} h={147}>
							Inventory
						</Block>
					</Block>
					<Block >
						<Block relative zIndex='10'>
							...
							{
								canPaint &&
									<Block align='center center' bgColor='white' border='1px solid divider' mt='0.5em' wide py='14px'>
										<ResetBoardButton
											{...btnProps('red')}
											w={btnWidth}
											onClick={
										...
										<Button ml='8' {...btnProps('blue')} fs='s' w={btnWidth * 2} onClick={props.onComplete()}>
											CHECK
										</Button>
									</Block>
							}
