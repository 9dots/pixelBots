		...
		return (
			<Block mr='0'>
				<Block onMouseLeave={actions.setPaintMode(false)} relative pr='10px' pt='0' align='stretch center' column display={isGridView ? 'block' : 'flex'} h='100%'>
					<Block border='1px solid divider' borderBottomWidth={0} bgColor='white' px wide align='center stretch' zIndex='1' relative minHeight='54px'>
						<Tabs tabs={['Grid', 'Instructions']} onClick={actions.setView} active='grid' borderBottomWidth={0} tabProps={{flex: true}} />
					</Block>
					...
					<Block relative zIndex='10' hide={!isGridView}>
						...
						<Block my relative minHeight={24}>
