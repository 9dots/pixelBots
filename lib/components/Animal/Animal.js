...
export default component({
  render ({props}) {
	  let {animal, active, id, cellSize, mode, animalTurn, animationSpeed, hasRun} = props
	  ...
	  const animalSize = parseFloat(cellSize) / 1.5 + 'px'
	  ...
	  return (
	    <Block
	      ...
	      backgroundSize='cover'
	    	onClick={mode === 'read' && [animalTurn, stopPropagation]} />
	  )
