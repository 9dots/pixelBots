...
const SelectDropdown = component({
  render ({props}) {
    ...
    if (name === 'color') return <ColorPicker dropdownTip borderRadius={99} colors={values} p={0} clickHandler={setArgument} paintColor={value} swatchProps={{h: innerHeight, w: innerWidth, fs: 16, borderRadius: 99}} />
