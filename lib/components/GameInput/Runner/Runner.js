...
export default component({
  render ({props, context, actions}) {
	  ...
	  const btnProps = {bgColor: '#7689a9'}

	  const selectable = sequence.filter(b => b.type !== 'repeat_end')
	      ...
	      <Block flex align='start center' pl='s'>
	      	{
	      		selected.length
    		      ?	<Checkbox
    		      		checkProps={{sq: 30, fs: 's', borderColor: 'rgba(black, .2)'}}
	      			...
	      			: <Button bgColor='#7689a9' onClick={invertSelection}>
