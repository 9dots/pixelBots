...
export default component({
  ...
  render ({props, actions, context, state}) {
	  ...
	  const CVL = VirtualList(Challenges, items, {height: 69, buffer: 25, container: document.getElementById('top')})
	  ...
	  return (
	    <Flex flexWrap='wrap' wide margin='0 auto'>
	      <Menu
	        ...
	        bgColor='white'
	        minWidth='820px'>
	        <Block pl='5%' pr='16px' py='8px' color='#999' fontWeight='800' align='start center' bgColor='transparent' borderBottom='1px solid #E0E0E0'>
	          <SortHeader
  ...
  reducer: {
	  ...
	  setItems: (state, items) => {console.log(items); return({items})}
  }
})
