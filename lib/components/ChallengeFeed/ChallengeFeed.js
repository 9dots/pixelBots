...
>>>>>>> 76888d2e9d3f33461aced819a87b05fa7c880838
	  ...
	  return (
	    <Block wide margin='0 auto' {...rest}>
	      <Block
	        ...
	        display='block'
	        minWidth='820px'>
	        <Block pl='40px' pr='16px' py='8px' color='#999' fontWeight='800' align='start center' bgColor='white' border='1px solid divider' borderBottomWidth={0}>
	          <SortHeader
