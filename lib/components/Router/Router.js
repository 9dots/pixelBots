...
const router = enroute({
  ...
  '/playlist/:playlistRef/:current': (params, props) => <AppLayout {...props} >
    <Playlist {...props} {...params}/>
  </AppLayout>,
  '/playlist/:playlistRef/instance/:instanceRef/:current': (params, props) => <AppLayout {...props} >
    <Playlist {...props} {...params}/>
  </AppLayout>,
  '/playlist/:playlistRef/instance/:instanceRef/:current/:subpage': (params, props) => <AppLayout {...props} >
    <Playlist {...props} {...params}/>
  </AppLayout>,
