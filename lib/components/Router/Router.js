...
import GameMapView from 'pages/GameMapView/GameMapView'
...
const router = enroute({
  ...
  '/map': track('Map', (params, props) => (
    <GameMapPage {...props} {...params} />
  )),
  '/map/:screen': track('Map', (params, props) => (
    <GameMapPage {...props} {...params} />
  )),
  '/map/:playlistRef/play/:current': track('Map Play', (params, props) => (
    <GameMapView {...props} {...params} />
  )),
  '/map/:playlistRef/play/:current/:subpage': track(
    'Map Play',
    (params, props) => (
      <GameMapView {...props} {...params} />
    )
