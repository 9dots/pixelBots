...
const imageAttrs = {
  'xlink:href': '/animalImages/chameleon.png',
  x: '0',
  y: '0',
  width: '100',
  height: '100'
...
//     <image xlink:href="/images/pixelTrans.png" x="0" y="0" width="100" height="100"></image>
//   </pattern>
// </defs>`
...
export default component({
  ...
  * onUpdate (prev, {props, context, state, actions, children}) {
    ...
    function getOpts () {
      return {
        ctx: new C2S(w, h, {defs, viewBox: `-0.5 -0.5 ${gridSize + 1} ${gridSize + 1}`}),
        cellSize: size,
        gridSize,
        numRows,
        painted,
