...
export default component({
  ...
  * onUpdate (prev, { props, context, state, actions, children }) {
    const { painted, palette, numRows, id, h, hideGrid, coordinates } = props
    const width = document.getElementById(id).offsetWidth
    const size = Math.floor(width / numRows)
    ...
    if (prev.props.numRows !== props.numRows || prev.props.coordinates !== props.coordinates) {
