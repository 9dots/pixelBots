      ...
      <Block class='app'>
        <Nav {...props} >
          <Block flex>
            ...
            {!isAnonymous &&
              <Block>
                <HeaderElement active={activeRoute === username} onClick={setUrl(`/${username}/playlists`)} text='Profile' icon='dashboard' />
                <HeaderElement active={activeRoute === 'create'} text='Create' icon='add' />
              </Block>
            }
          </Block>
        ...
        <Block relative left='80px' w='calc(100% - 80px)'>
          {children}
        </Block>
      </Block>
    )
