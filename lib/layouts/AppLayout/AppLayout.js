        ...
        <Nav {...props}>
          <Block flex wide>
            {isAnonymous ? (
              ...
              //   text='Home'
              //   color='red'
              //   image='/images/holidays/halloween/pumpkinhome.png'
              //   url='/' />
            )}
            <HeaderElement
              text='Courses'
            ...
            {!isAnonymous && (
              <HeaderElement
                ...
                text='Profile'
                image={props.userProfile.photoURL} />
            )}
            <HeaderElement
              color='green'
          ...
          <HeaderElement
            onClick={openModal(() => <CodeLinkModal />)}
            text='Code'
            icon='link' />
          {!isAnonymous && (
            <Block>
...
const HeaderElement = component({
  render ({ props, children, context }) {
    ...
    const handleClick = onClick || context.setUrl(url)
    ...
    return (
      <Block
        ...
        {text && (
          <Text mt='8px' fs='xxs' fontWeight='600'>
            {text}
          </Text>
        )}
        {children}
