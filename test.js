...
exports.default = function (color1, color2) {
  var c1 = colorArrayToObj((0, _hexToRgb2.default)(color1));
  var c2 = colorArrayToObj((0, _hexToRgb2.default)(color2));
  return Math.sqrt(Math.pow(c1.r - c2.r, 2) + Math.pow(c1.g - c2.g, 2) + Math.pow(c1.b - c2.b, 2));
};

var _hexToRgb = __webpack_require__(64);
...
function colorArrayToObj(arr) {
  return arr.reduce(function (acc, next, i) {
    if (i === 0) return (0, _extends3.default)({}, acc, { r: next });
    if (i === 1) return (0, _extends3.default)({}, acc, { g: next });
    return (0, _extends3.default)({}, acc, { b: next });
  }, {});
}
...
var createDefaultStream = __webpack_require__(73);
var Test = __webpack_require__(75);
var createResult = __webpack_require__(74);
...
var _tape = __webpack_require__(20);
...
(0, _tape2.default)('<colorDistance/> should work', function (t) {
  console.log('here');
  t.plan(1);
  t.equal((0, _2.default)('#fff', '#f5f5f5') < (0, _2.default)('#ffffff', '#000'), true);
});
...
var through = __webpack_require__(1);
var resumer = __webpack_require__(70);
...
/* WEBPACK VAR INJECTION */(function(__dirname) {var deepEqual = __webpack_require__(51);
var defined = __webpack_require__(6);
