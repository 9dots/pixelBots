...
exports.images = exports.teacherBot = exports.gameImages = exports.capabilities = exports.capabilityOrder = exports.arrowColors = exports.typeColors = exports.typeOrder = undefined
...
var _marked = /* #__PURE__ */ _regenerator2.default.mark(checkColor),
  _marked2 = /* #__PURE__ */ _regenerator2.default.mark(ifColor),
  _marked3 = /* #__PURE__ */ _regenerator2.default.mark(repeatFn),
  _marked4 = /* #__PURE__ */ _regenerator2.default.mark(
    callFn
  ) /**
                                                                 * Imports
                                                                 */
...
function createDocs (traits, palette) {
  return (0, _mapObj2.default)(
    function (val, key) {
      return traits[key] === true || key === 'comment' || key === 'lineBreak'
...
exports.typeOrder = typeOrder
exports.typeColors = typeColors
exports.arrowColors = arrowColors
