...
function frameReducer (frame, type, args) {
  ...
  return [].concat(
    fn.apply(undefined, [frame].concat((0, _toConsumableArray3.default)(args)))
  )
} /**
   * Imports
   */
...
function paint (state, id) {
  ...
  return (0, _extends5.default)({}, state, {
    ...
    painted: (0, _extends5.default)(
      {},
      state.painted,
      (0, _defineProperty3.default)(
        {},
        state.animals[id].current.location,
        color
      )
    )
  })
...
function paintZ (state, id) {
  ...
  var paintLocations = [].concat(
    (0, _toConsumableArray3.default)(paintLine(location, heading, 2)),
    (0, _toConsumableArray3.default)(paintLine(startPoint2, heading, 2))
  )
  ...
  return (0, _extends5.default)({}, state, {
    ...
    painted: (0, _extends5.default)(
      ...
      locations.reduce(function (acc, loc) {
        return (0,
          _extends5.default)({}, acc, (0, _defineProperty3.default)({}, loc, color))
      }, {})
    )
  })
}
...
function createPaintFrames (frame, code, seed) {
  return createFrames(frame, code, seed)
    ...
    .reduce((acc, painted, i, arr) => {
      ...
      if (
        Object.keys(painted).some(key => prev.painted[key] !== painted[key])
      ) {
...
function filterPaints (frames) {
  return frames
    ...
    .reduce(function (acc, f) {
      return !acc.length ||
        !(0, _deepEqual2.default)(f.painted, acc[acc.length - 1].painted)
        ? acc.concat(f)
        : acc
    }, [])
}
...
function generatePainted (state, code) {
  ...
  return (typeof initialPainted === 'undefined'
    ? 'undefined'
    : (0, _typeof3.default)(initialPainted)) === 'object'
    ? initialPainted
    : getLastFrame(
      state,
      code === undefined
        ? getIterator(
          initialPainted,
          _animalApis2.default['teacherBot'].default(active)
        )
        : code
    )
}
...
function getIterator (code, api) {
  ...
  var regex = new RegExp('\\s*\\b(' + prepend.join('|') + ')\\b', 'g')
  var autoYielded = (0, _autoYieldDelegate2.default)(
    newCode,
    api,
    null,
    'callFn'
